...
当日はどちらで進めても構いません。講師が主線をアナウンスしますが、途中で乗り換えても大丈夫です。
...
### 0. 講師からの招待メールを承認する ← 最優先

講師があなたのGitHub IDをこのリポジトリの **Collaborator**（共同編集者）に招待します。
...
> 招待が届いていない人は、自分のGitHub IDを講師に伝えてください。
...
| [facilitator_guide.md](facilitator_guide.md) | 講師用ガイド（受講者は読まなくてOK） |
